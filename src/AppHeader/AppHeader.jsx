...
export let AppHeader = props => {
  return <header className={styles.appHeader}>
    ...
    <div className={styles.filter}>
      ...
      <Search value={props.searchValue} changeHandler={props.searchValueHandler} focused={props.searchFocused} focusHandler={props.searchFocusHandler} blurHandler={props.searchBlurHandler}/>
    </div>
